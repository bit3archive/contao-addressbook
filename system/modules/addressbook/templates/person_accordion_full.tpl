<div class="person-toggler person-toggler-<?php echo $this->upath ?>"><?php if ($this->title): ?><strong><?php echo $this->title; ?></strong> <?php endif; ?><?php echo $this->name ?></div>

<div class="person_full block person-accordion person-accordion-<?php echo $this->upath ?>"><div class="person-accordion_content">
